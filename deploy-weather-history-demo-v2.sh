...
apigeecli targetservers create --name "bigquery" --host "bigquery.googleapis.com" --port 443 --sslinfo true --org "$PROJECT" --token "$TOKEN" --env "$APIGEE_ENV"
...
apigeecli products create --name weather-history-v2-premium-product --displayname "Weather History v2 Premium" --opgrp ./src/config/weather-history-v2-product-ops.json --envs "$APIGEE_ENV" --approval auto --quota 20 --interval 1 --unit minute --org "$PROJECT" --token "$TOKEN"

apigeecli products create --name weather-history-v2-freemium-product --displayname "Weather History v2 Freemium" --opgrp ./src/config/weather-history-v2-product-ops.json --envs "$APIGEE_ENV" --approval auto --quota 10 --interval 1 --unit minute --org "$PROJECT" --token "$TOKEN"
